	...
	<div class="container-fluid">
		<div class="row">
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
				...
				<h1 class="m-3">Add Seller</h1>
				<hr class="mx-1">
				<div class="container rounded mb-5" style="background-color: #fff;">
					<form:form modelAttribute="sellerForm" action="addSeller"
						...
						<div class="d-flex justify-content-center">
							<button type="submit" class="btn btn-primary rounded m-2">Add Seller</button>
							<a class="btn btn-danger rounded m-2" href="<c:url value='/userAdministration'/>">Cancel</a>
						</div>
					</form:form>
				</div>
			</main>
