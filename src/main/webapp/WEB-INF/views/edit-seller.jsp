	...
	<div class="container-fluid">
		<div class="row">
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
				...
				<h1 class="m-3">Edit Seller</h1>
				<hr class="mx-1">
				<div class="container rounded bg-white mb-5">
					<div class="container rounded" style="background-color: #fff;">
						<form:form modelAttribute="sellerForm" action="updateSeller"
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<form:input path="user.dateOfBirth" type="date"
													class="form-control" name="date-of-birth"
													id="date-of-birth" required="true" />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<form:input path="seller.storeName" type="text"
											...
											placeholder="Enter store name" maxlength="255"
											required="true" />
									</div>
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<form:textarea path="seller.storeDescription"
											...
											placeholder="Enter store description" rows="5"></form:textarea>
									</div>
								</div>
							</div>
							<h5>Store Address</h5>
