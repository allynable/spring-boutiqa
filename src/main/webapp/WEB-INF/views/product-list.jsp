	...
	<div class="container my-5">
		<div class="row justify-content-center">
			<c:forEach var="product" items="${products}">
				<div class="col-10 col-md-6 col-lg-4 my-5">
                    <div class="item">
                            <img src="<c:url value='${product.productImage.imageUrl}'/>" class="w-100" alt="">
                        <div class="down-content">
                            <h4 class="py-1 product-name">${product.productName}</h4>
                            <p class="card-text product-description" style="min-height:3em">${product.productDescription}</p>
                            <div class="row">
								<div class="col-sm-6">
